...
namespace WebSmsin
{
    public class SerilogMiddleware
    {
        ...
        public async Task Invoke(HttpContext httpContext)
        {
            ...
            try
            {
                var requestIdHeaderValue = httpContext.Request.Headers.FirstOrDefault(x => x.Key == "Request-Id").Value;

                using (LogContext.PushProperty("TraceId", requestIdHeaderValue))
                {
